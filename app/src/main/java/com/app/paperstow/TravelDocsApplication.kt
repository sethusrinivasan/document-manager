...
import com.app.paperstow.debug.CrashHandler
...
class TravelDocsApplication : Application() {
    override fun onCreate() {
        ...
        DebugLogger.i("App", "Paperstow started. Build: ${BuildConfig.VERSION_NAME}")
    ...
    private fun verifyDatabaseTables() {
        try {
            ...
            if (!hasDocumentsTable) {
                ...
                com.app.paperstow.debug.UsageTelemetry.action("App", "corrupted_db_deleted")
            }
        } catch (e: Exception) {
