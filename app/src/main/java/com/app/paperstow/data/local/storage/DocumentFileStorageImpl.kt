package com.app.paperstow.data.local.storage
...
class DocumentFileStorageImpl @Inject constructor(
    ...
    override suspend fun replace(fileId: String, fileData: ByteArray): Result<Unit> = runCatching {
        val file = findFile(fileId)
            ?: throw IllegalArgumentException("File not found: $fileId")
        file.writeBytes(encrypt(fileData))
    }
