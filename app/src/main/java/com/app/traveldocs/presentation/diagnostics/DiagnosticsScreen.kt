...
private fun repairDatabase(context: android.content.Context) {
    ...
    try {
        ...
        com.app.traveldocs.debug.DebugLogger.i("Diagnostics", "Repair: deleted corrupt DB. Room will recreate tables on next query.")
        com.app.traveldocs.debug.DebugLogger.i("Diagnostics", "Note: document metadata is lost but encrypted files on disk remain intact.")
